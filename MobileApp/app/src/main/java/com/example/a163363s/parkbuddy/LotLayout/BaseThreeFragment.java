 ...
 */
public class BaseThreeFragment extends Fragment {
    ...
    public void onStart() {
        ...
        btn=(Button)getActivity().findViewById(R.id.buti);

        Car1=(ImageView) getActivity().findViewById(R.id.imgb31);
        Car3=(ImageView) getActivity().findViewById(R.id.imgb36);


        Car4=(ImageView) getActivity().findViewById(R.id.imgb38);

        Car2=(ImageView) getActivity().findViewById(R.id.imgb30);



        Car5=(ImageView) getActivity().findViewById(R.id.imgb34);
        ...
        Car1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(signal1>0)
                {
                    ...
                    btn.setText("Proceed with Spot AO1 (Base Three)");
        ...
        Car2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (signal2 > 0) {
                    ...
                    btn.setText("Proceed with Spot BO5 (Base Three)");
        ...
        Car3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (signal3 > 0) {
                    ...
                    btn.setText("Proceed with Spot BO1 (Base Three)");
                    Car2.setEnabled(false);
                    Car1.setEnabled(false);
                    Car4.setEnabled(false);
                    Car5.setEnabled(false);
        ...
        Car4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (signal4 > 0) {
                    ...
                    btn.setText("Proceed with Spot BO3 (Base Three)");
                    Car2.setEnabled(false);
                    Car3.setEnabled(false);
                    Car1.setEnabled(false);
                    Car5.setEnabled(false);
        ...
        Car5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(signal5>0)
                {
                    ...
                    btn.setText("Proceed with Spot AO4 (Base Three)");
                    Car2.setEnabled(false);
                    Car3.setEnabled(false);
                    Car4.setEnabled(false);
                    Car1.setEnabled(false);

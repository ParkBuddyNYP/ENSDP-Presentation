 ...
 */
public class BaseTwoFragment extends Fragment {

    private ImageView Car1,Car2,Car3,Car4,Car5;
    private  Button btn;
    int signal1=0;
    int signal2=0;
    int signal3=0;
    ...
    public void onStart() {
        ...
        btn=(Button)getActivity().findViewById(R.id.but);


        Car1=(ImageView) getActivity().findViewById(R.id.imgb51);
        Car3=(ImageView) getActivity().findViewById(R.id.imgb56);


        Car4=(ImageView) getActivity().findViewById(R.id.imgb58);

        Car2=(ImageView) getActivity().findViewById(R.id.imgb50);



        Car5=(ImageView) getActivity().findViewById(R.id.imgb54);
        ...
        Car1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(signal1>0)
                {
                    ...
                    btn.setText("Proceed with Spot AO1 (Base Two)");
        ...
        Car2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (signal2 > 0) {
                    ...
                    btn.setText("Proceed with Spot BO5 (Base Two)");
        ...
        Car3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (signal3 > 0) {
                    ...
                    btn.setText("Proceed with Spot BO1 (Base Two)");
                    Car2.setEnabled(false);
                    Car1.setEnabled(false);
                    Car4.setEnabled(false);
                    Car5.setEnabled(false);
        ...
        Car4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(signal4>0)
                {
                    ...
                    btn.setText("Proceed with Spot BO3 (Base Two)");
                    Car2.setEnabled(false);
                    Car3.setEnabled(false);
                    Car1.setEnabled(false);
                    Car5.setEnabled(false);
        ...
        Car5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(signal5>0)
                {
                    ...
                    btn.setText("Proceed with Spot AO4 (Base Two)");
                    Car2.setEnabled(false);
                    Car3.setEnabled(false);
                    Car4.setEnabled(false);
                    Car1.setEnabled(false);

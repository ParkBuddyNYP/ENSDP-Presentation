package com.example.a163363s.parkbuddy.helpers;
...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    private static final String DATABASE_NAME = "parkbuddy.db";
    private static final String DATABASE_CREATESQL =
            "CREATE TABLE Task (id INTEGER PRIMARY KEY AUTOINCREMENT, description TEXT, colour TEXT, status TEXT, datedue INTEGER );";

...
public class LocationListViewAdapter extends ArrayAdapter {
    ...
    public LocationListViewAdapter(Context context, Location[] locations)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
    {
        ...
        if (itemView == null)
            itemView = ((Activity)this.getContext()).getLayoutInflater().inflate(R.layout.listview_location, null);

        ImageView imageView = itemView.findViewById(R.id.imageView);
        imageView.setImageResource(locations[position].getCameraimageResource());
